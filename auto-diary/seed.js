...
async function seedRecordsForCar(carId, token, carName) {
  ...
  await post(
    '/data/service-records',
    {
      carId,
      type: 'Смяна на масло',
      brand: 'Castrol Edge 5W-30',
      mileage: 51500,
      price: 120,
      date: '2026-02-10',
      nextServiceDate: '2027-02-10',
      nextServiceMileage: 61500,
  ...
  await post(
    '/data/documents',
    {
      ...
      comment: 'Платена за цяла година',
    },
    token,
  );
